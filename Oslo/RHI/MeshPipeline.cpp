...
// > Create Time: 2025-04-06 16:19:35
//
...
MeshPipeline::MeshPipeline(GraphicsPipelineSpecs& specs)
{
    ShaderModule& meshBytecode = specs.Bytecodes[ShaderType::Mesh];
    ...
    HRESULT Result = RHI::GetDevice()->GetDevice()->CreatePipelineState(&streamDesc, IID_PPV_ARGS(&mPipeline));
    if (FAILED(Result)) {

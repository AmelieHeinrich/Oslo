...
// > Create Time: 2025-04-06 15:43:46
//
...
GraphicsPipeline::GraphicsPipeline(GraphicsPipelineSpecs& specs)
{
    ShaderModule& vertexBytecode = specs.Bytecodes[ShaderType::Vertex];
    ShaderModule& fragmentBytecode = specs.Bytecodes[ShaderType::Pixel];
    ...
    HRESULT result = RHI::GetDevice()->GetDevice()->CreateGraphicsPipelineState(&Desc, IID_PPV_ARGS(&mPipeline));
